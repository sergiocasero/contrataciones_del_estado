...
public class SpreeadSheetManager {
	...
	public SpreeadSheetManager(boolean dosHojasLicitaciones, boolean hojaEMP, boolean hojaCPM) throws Exception{
		...
		// Se crea a partir de una plantilla y se a�aden dos hojas
		try {
			...
			if(dosHojasLicitaciones) {
				//Se a�aden dos hojas al woorkbook
	...
	/**
	 * Funci�n que devuleve el estilo de XLSX asociado al tipo formato
	 * @param 
	 * @return
	 */
