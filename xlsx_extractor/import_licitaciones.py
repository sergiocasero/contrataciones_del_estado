    ...
    for subdir, dirs, files in os.walk(carpeta):
        for file in files:
            if file.endswith('.xlsx'):
                ...
                df = pd.read_excel(file_path, sheet_name='Licitaciones', engine='openpyxl')

                # Imprimir nombres actuales de las columnas
                print(f"Columnas actuales en el archivo {file}:")
                print(df.columns)
